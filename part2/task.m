...
num_control = [ 18 18 18 ];%assign number of control values along each axis
...
rand_z = randperm(obj.img_size(3),5) %create 5 random z values within limits of img_size z directions; no repeats
